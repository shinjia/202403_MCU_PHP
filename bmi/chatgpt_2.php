...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
    ...
    <input type="number" id="weightInput" name="weight" min="0" max="500" step="1" value="0" oninput="updateRangeInput(this.value, 'weightRange')" required><br>

    <button type="submit">計算BMI</button>
</form>

<script>
    function updateTextInput(value, inputId) {
        document.getElementById(inputId).value = value;
    }

    function updateRangeInput(value, rangeId) {
