...
foreach($a_dir as $one) {  
   ...
   $url_delete = 'img_delete.php?workcode=' . $workcode . '&uid=' . $uid . '&page=' . $page . '&nump=' . $nump . '&file=' . $one;
...
$url_delete2 = 'img_delete.php?workcode=' . $workcode . '&uid=' . $uid . '&page=' . $page . '&nump=' . $nump . '&file=';
