...
foreach($a_dir as $one) {  
   ...
   $url_delete = 'img_delete.php?restcode=' . $restcode . '&uid=' . $uid . '&page=' . $page . '&nump=' . $nump . '&file=' . $one;
...
<form name="form1" method="post" action="img_save.php" enctype="multipart/form-data"> 
   ...
   <table border="0" style="border: 1px solid red; padding:4px; background-color:#FFFFAA;">
      <tr>
         ...
         <input type="hidden" name="restcode" value="{$restcode}">
...
$url_delete2 = 'img_delete.php?restcode=' . $restcode . '&uid=' . $uid . '&page=' . $page . '&nump=' . $nump . '&file=';
